...
void EndScene::start()
{
	...
	m_label = new Label("Level Completed!", "Roddenberry", 65, orange, glm::vec2(400.0f, 80.0f));
	...
	m_enemiesDestroyed = new Label("Klingons Destroyed: " + std::to_string(GameManager::Instance()->getEnemiesDestroyed()) + "/" + std::to_string(GameManager::Instance()->getEnemiesCount()) , "Roddenberry", 40, orange, glm::vec2(400.0f, 325.0f),0,true);
